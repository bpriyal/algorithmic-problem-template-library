class Solution {
    ...
    int getNum(String s) {
        ...
        if (s.charAt(0) == '-') {
            ...
            System.out.println(min.charAt(j));
            while (j < s.length()) {
                if ((int)s.charAt(j) < (int)min.charAt(j)) return Integer.parseInt(s);
                else if((int)s.charAt(j) > (int)min.charAt(j)) return Integer.MIN_VALUE;
                else if ((int)s.charAt(j) == (int)min.charAt(j)) j++;
            }
            //     {   System.out.println(s.charAt(j));
            // System.out.println(min.charAt(j));
            //         j++;}
            ...
            while (j < 10) {
                if ((int)s.charAt(j) < (int)max.charAt(j)) return Integer.parseInt(s);
                else if ((int)s.charAt(j) > (int)max.charAt(j)) return Integer.MAX_VALUE;
                else if ((int)s.charAt(j) == (int)max.charAt(j)) j++;
            }
            if (j == 10) return Integer.parseInt(s);
