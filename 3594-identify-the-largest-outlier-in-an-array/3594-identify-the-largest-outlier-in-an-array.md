<h1>3594 - Identify the Largest Outlier in an Array</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/identify-the-largest-outlier-in-an-array/">identify-the-largest-outlier-in-an-array</a></h2><p>You are given an integer array <code>nums</code>. This array contains <code>n</code> elements, where <strong>exactly</strong> <code>n - 2</code> elements are <strong>special</strong><strong> numbers</strong>. One of the remaining <strong>two</strong> elements is the <em>sum</em> of these <strong>special numbers</strong>, and the other is an <strong>outlier</strong>.</p>
