<h1>436 - Find Right Interval</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/find-right-interval/">find-right-interval</a></h2><p>You are given an array of <code>intervals</code>, where <code>intervals[i] = [start<sub>i</sub>, end<sub>i</sub>]</code> and each <code>start<sub>i</sub></code> is <strong>unique</strong>.</p>
