<h1>1529 - Max Difference You Can Get From Changing an Integer</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/max-difference-you-can-get-from-changing-an-integer/">max-difference-you-can-get-from-changing-an-integer</a></h2><p>You are given an integer <code>num</code>. You will apply the following steps to <code>num</code> <strong>two</strong> separate times:</p>
