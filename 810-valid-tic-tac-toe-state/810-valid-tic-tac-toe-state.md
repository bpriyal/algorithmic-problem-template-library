<h1>810 - Valid Tic-Tac-Toe State</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/valid-tic-tac-toe-state/">valid-tic-tac-toe-state</a></h2><p>Given a Tic-Tac-Toe board as a string array <code>board</code>, return <code>true</code> if and only if it is possible to reach this board position during the course of a valid tic-tac-toe game.</p>
