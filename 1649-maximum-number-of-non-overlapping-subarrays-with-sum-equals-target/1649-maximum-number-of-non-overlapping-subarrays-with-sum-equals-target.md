<h1>1649 - Maximum Number of Non-Overlapping Subarrays With Sum Equals Target</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/maximum-number-of-non-overlapping-subarrays-with-sum-equals-target/">maximum-number-of-non-overlapping-subarrays-with-sum-equals-target</a></h2><p>Given an array <code>nums</code> and an integer <code>target</code>, return <em>the maximum number of <strong>non-empty</strong> <strong>non-overlapping</strong> subarrays such that the sum of values in each subarray is equal to</em> <code>target</code>.</p>
