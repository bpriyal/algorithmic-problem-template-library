<h1>381 - Insert Delete GetRandom O(1) - Duplicates allowed</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/insert-delete-getrandom-o1-duplicates-allowed/">insert-delete-getrandom-o1-duplicates-allowed</a></h2><p><code>RandomizedCollection</code> is a data structure that contains a collection of numbers, possibly duplicates (i.e., a multiset). It should support inserting and removing specific elements and also reporting a random element.</p>
